...
namespace Clientes.Controllers
{
    public class NotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,TextoNota,Responsavel,DataRealizar")] Nota nota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,TextoNota,Responsavel,DataRealizar")] Nota nota)
        {
            if (id != nota.Id)
            {
                return NotFound();
